 ...
 SubShader {
     ...
     v2f vert (appdata_t v)
     {
        ...
        UNITY_SETUP_INSTANCE_ID(v);
         ...
         float3 directed = RotateAroundYInDegrees(v.vertex, _Direction);
         float3 rotated = mul( rotationMatrix( normalize(_RotationAxis.xyz), _Rotation * UNITY_PI / 180.0), directed).xyz;
