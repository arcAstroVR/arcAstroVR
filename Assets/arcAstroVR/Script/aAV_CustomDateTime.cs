...
public class aAV_CustomDateTime : MonoBehaviour
{
    ...
    public string SetDateTime(int a)
    {
        return a + "回目";
    }

    public void SetDateTime(int _year, int _month, int _day, int _hour, int _minute, int _second, Era _era) {
        this.year = _year;
        this.month = _month;
        this.day = _day;
        this.hour = _hour;
    ...
    public static double ToJulianDay(aAV_CustomDateTime customDateTime) {
    ...
    public aAV_CustomDateTime FromJulianDay(double jday) {
        ...
        aAV_CustomDateTime fjd = GetComponent<aAV_CustomDateTime>();
        fjd.SetDateTime(y, m, d, hr, mn, sc, era);
        return fjd;
    }
}
